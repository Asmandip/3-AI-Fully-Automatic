...
import dash
from dash_extensions.enrich import DashProxy, Output, Input, State  # pip install dash-extensions
...
def save_settings_and_update_bot(n_clicks, pairs, timeframes, strategy, strategy_mode, trade_mode):
    ...
    asyncio.create_task(db.save_settings(settings_doc))
